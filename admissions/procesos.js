...
const enviarControl = async (id_admision) => {
  ...
  await Promise.all([admision_aspirantes_anio.update({ matriculado: 1 }, { where: { id: id_admision } })]);
