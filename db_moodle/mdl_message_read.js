    ...
    },
    {
      ...
      indexes: [
        ...
        },
        {
          ...
          using: 'BTREE',
          fields: [{ name: 'notification' }, { name: 'timeread' }],
        },
        {
          name: 'mdl_messread_usetimnot_ix',
          using: 'BTREE',
          fields: [{ name: 'useridfrom' }, { name: 'timeuserfromdeleted' }, { name: 'notification' }],
        },
        {
          name: 'mdl_messread_usetimnot2_ix',
          using: 'BTREE',
          fields: [{ name: 'useridto' }, { name: 'timeusertodeleted' }, { name: 'notification' }],
        },
      ],
    }
  );
