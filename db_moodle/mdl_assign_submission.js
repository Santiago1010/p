    ...
    },
    {
      ...
      indexes: [
        ...
        },
        {
          ...
          unique: true,
          using: 'BTREE',
          fields: [{ name: 'assignment' }, { name: 'userid' }, { name: 'groupid' }, { name: 'attemptnumber' }],
        },
        {
        ...
        },
        {
          ...
          using: 'BTREE',
          fields: [{ name: 'attemptnumber' }],
        },
        {
          name: 'mdl_assisubm_assusegrolat_ix',
          using: 'BTREE',
          fields: [{ name: 'assignment' }, { name: 'userid' }, { name: 'groupid' }, { name: 'latest' }],
        },
        {
