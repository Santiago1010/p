...
function initModels(sequelize) {
  ...
  web_propuestas_planes_pago.belongsTo(web_suscripciones_propuestas, {
    as: 'id_propuesta_web_suscripciones_propuesta',
    foreignKey: 'id_propuesta',
  });
  web_suscripciones_propuestas.hasMany(web_propuestas_planes_pago, {
    as: 'web_propuestas_planes_pagos',
    foreignKey: 'id_propuesta',
  });
