      ...
      indexes: [
        {
          ...
          unique: true,
          using: 'BTREE',
          fields: [{ name: 'id_ruta_aprendizaje_sugerencia' }],
        },
        {
          name: 'id_ruta_aprendizaje_origen_id_ruta_aprendizaje_destino',
          unique: true,
          using: 'BTREE',
          fields: [{ name: 'id_ruta_aprendizaje_origen' }, { name: 'id_ruta_aprendizaje_destino' }],
        },
        {
          name: 'FK__web_rutas_aprendizaje_2',
          using: 'BTREE',
          fields: [{ name: 'id_ruta_aprendizaje_destino' }],
        },
      ],
    }
  );
